...
class OutcomeOnClose extends FCMLegacy {
    ...
    // if it definitely thiks we should update you'll get a true arg.
...
manywho.component.register('OutcomeOnClose', OutcomeOnClose);